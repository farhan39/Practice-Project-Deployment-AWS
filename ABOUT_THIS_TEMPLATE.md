...
├── practice_project_deployment_aws             # The main python package for the project
...
e.g: `cat practice_project_deployment_aws/VERSION` will get the project version without harming
