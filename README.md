...
- 🎯 Entry points to execute your program using `python -m <practice_project_deployment_aws>` or `$ practice_project_deployment_aws` with basic CLI argument parsing.
...
---
# practice_project_deployment_aws Flask Application

Awesome practice_project_deployment_aws created by farhan39
...
```bash
git clone https://github.com/farhan39/Practice-Project-Deployment-AWS practice_project_deployment_aws
cd practice_project_deployment_aws
make install
```
...
```bash
pip install practice_project_deployment_aws
```
...
```bash
$ practice_project_deployment_aws
```

or

```bash
$ python -m practice_project_deployment_aws
```
...
```bash
practice_project_deployment_aws create-db   # run once
practice_project_deployment_aws populate-db  # run once (optional)
practice_project_deployment_aws add-user -u admin -p 1234  # ads a user
practice_project_deployment_aws run
```
